...
var postRouter = function () {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (posts) {
                        ...
                        return [2 /*return*/, res.status(404).json({ message: "No posts found" })];
                    }
                    return [2 /*return*/];
            }
        });
    ...
    router
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.GetPostById(req.params.id)];
                case 1:
                    post = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.DeletePosts(req.params.id)];
                case 1:
                    post = _a.sent();
                    if (!post) {
                        return [2 /*return*/, res.status(404).json({ message: "post not found" })];
