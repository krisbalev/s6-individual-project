    ...
    return (
        <div className="fixed inset-0 z-10 flex items-center justify-center">
            ...
            <div className="bg-white rounded-lg p-8 z-10 w-1/3">
                <h2 className="text-2xl font-medium mb-4 text-black text-center">Add New Post</h2><form onSubmit={handleSubmit}>
                    <div className="mb-4">
                    ...
                    <div className="flex justify-end">
                        <button type="button" onClick={onClose} className="mr-2 bg-gray-400 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded">
                            Close
                        </button>
